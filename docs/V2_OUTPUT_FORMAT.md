# OneView V2 Output Format

## Overview

OneView compiler giờ đã generate file JS với class-based structure thay vì function wrapper đơn thuần. Cấu trúc mới giúp:
- Tổ chức code rõ ràng hơn
- Dễ extend và customize
- Tương thích với oneview framework architecture
...
### Key Changes
1. Always import from `'oneview'` (not `'onelaraveljs'`)
